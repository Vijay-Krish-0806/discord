      ...
      <div className="flex h-[calc(100vh-80px)]">
        ...
        <div className="w-1/2 flex items-center justify-start relative">
          <div className="relative">
            ...
            <div className="rounded-full bg-white p-50 shadow-2xl -ml-60 -mt-15 relative">
              {" "}
              {/* Reduced padding and scaled */}
              <Image
                src="/Vconnect.png"
                alt="App Logo"
        ...
        <div className="w-1/2 flex items-center justify-center p-10">
          {" "}
          {/* Reduced padding */}
          <section className="relative z-10 w-full max-w-xl -mt-20">
            {" "}
            {/* Reduced max-width */}
            <div
            ...
            >
              ...
              <p className="text-lg text-gray-300 mb-8 text-left leading-relaxed">
                {" "}
                {/* Reduced margin and changed to text-lg */}
                VConnect is a modern platform for communities, friends, and
                teams to connect, share, and hang out in a seamless, secure
                environment.
              </p>
              <div className="flex flex-wrap gap-4 text-sm text-gray-400">
                {" "}
                {/* Changed to flex-wrap and reduced gap */}
